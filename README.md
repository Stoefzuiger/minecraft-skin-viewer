...
It can use 4 pieces of data, but none are required. 
...
- Skins can render incorrectly in some cases. This has to do with the different skin texture layouts that have existed throughout the years. Because of this, the model's UV mapping becomes wrong, and the texture will map incorrectly to the model.
